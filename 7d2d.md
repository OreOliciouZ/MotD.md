...
* /map
does open the live map

* /bloodmoon
tells you the next bloodmoon time

* /died
does teleport you to your last death position

* /discord
does invite you to discord

* /gimme
gives you different available rewards (you can repeat this every hour again)

* /home
does tell you, your saved home locations

* /fhome 'name'
does teleport you to the chosen saved location

* /home del 'name'
does delete the saved home position
...
* /reward
gives you a random reward from the [list](https://7daystodie-servers.com/server/107370/vote/)
