...
* Please refrain from using any other language than English in the general chat
* Rules are subject to change

## LIMITS

* Backpack size up to 96 slots
* Turrets max 4 in a range of 3x3 chunks
...
Missing Stars is not associated with Fun Pimps

Please do not report any game bugs you experience to the Fun Pimps, unless you can reproduce it in a vanilla game!
...
opens the [voting site](https://7daystodie-servers.com/server/107370/)
